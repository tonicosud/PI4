...
fig = px.bar(df, x="date", y=column, title=column + ' - ' + state,color="Número acumulado de casos", color_continuous_scale=px.colors.sequential.Viridis)#color_continuous_scale = 'Inferno')
fig.update_layout( 
    updatemenus=[
            dict(
                buttons=list([
